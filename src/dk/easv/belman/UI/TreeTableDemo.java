...
public class TreeTableDemo {
    ...
    private final String[] headings = {"ID", "DueDate", "Material ID", "Length", "Width", "Circumference"};
    private Node root;
...
// ============================================================= treetable
    ...
    private void addSalesOrders() {
        for (Object[] element : initialData) {
            Object[] data = new Object[]{element[0]};
            ...
            child.add(person);
            addItems(person);
            addProductionOrders(child);
        }
    }

    private void addProductionOrders(FamilyNode parent) {
    ...
    private void addItems(PersonNode parent) {
    ...
    private void loadData() {
        ...
        String salesOrderID = "123-123-123";
        String proOrderID = "123-123-333";
        String proDueDate = "29-04-2013";

        initialData = new Object[][]{
            {salesOrderID, proOrderID, proDueDate, "", "", ""},};

        childData = new Object[][]{
            {"123-123-333", "30-04-2013", null, "Hej", "hej", "lol"},
            {"123-123-333", "30-04-2013", null, "Hej", "hej", "lol"},
            {"123-123-123", "Crazy", null, "Hej", "Hej", "lol"}};

        nameData = new Object[][]{
            {"123-123-123", "123-123-333", "Crazy", "blaa"}
